function notez=note42z(x)  %4·Ö°ëÒô·ûº¯Êý 
fs=44100;
dt=1/fs;
T4 = 0.5*1.5;

t4 = [0:dt:T4];
%mod4=(2*7.5/1.5*t4).*(stepfun(t4,0)-stepfun(t4,1.5*0.1))+(2.25-3.75*2/1.5*t4).*(stepfun(t4,1.5*0.1)-stepfun(t4,1.5*1/6))+(stepfun(t4,1.5*1/6)-stepfun(t4,1.5*1/3))+(3-6/1.5*t4).*(stepfun(t4,1.5*1/3)-stepfun(t4,0.5*1.5));
